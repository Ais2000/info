	...
	<div class="card card-outline card-primary" id="table">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_evaluation" id="button"><i class="fa fa-plus"></i> Add New Evaluation</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					<tr>
						...
						<td><b id="fontsize"><?php echo ($row['task']) ?></b></td>
						<td><b id="fontsize"><?php echo ucwords($row['name']) ?></b></td>
						<?php if($_SESSION['login_type'] != 1): ?>
						<td><b id="fontsize"><?php echo ucwords($row['ename']) ?></b></td>
						<?php endif; ?>
						<td><b id="fontsize"><?php echo number_format($row['pa'],2)."%" ?></b></td>
