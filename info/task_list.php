			...
			<table class="table tabe-hover table-condensed" id="list">
				...
				<tbody>
					...
					elseif($_SESSION['login_type'] == 1)
						$where = " where evaluator_id = '{$_SESSION['login_id']}' ";
					...
					<tr>
						...
						<td>
							<p><b id="fontsize"><?php echo ucwords($row['task']) ?></b></p>
							<p class="truncate"><?php echo strip_tags($desc) ?></p>
						</td>
						<td><b id="fontsize"><?php echo date("M d, Y",strtotime($row['due_date'])) ?></b></td>
						<?php if($_SESSION['login_type'] != 0): ?>
						<td><p><b id="fontsize"><?php echo ucwords($row['name']) ?></b></p></td>
						<?php endif; ?>
						<td>
                        	<?php 
                        	if($row['status'] == 0){
